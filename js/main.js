//Required ablilities of a calculator:
...
//Optional features:
//should accept longer arithmethic operations
//desplay all input as it is being entered
//store previous total as start of next operation
//clear button should clear all entries
//should prevent invalid inputs (operators next to each other, two decimals next to each other)
